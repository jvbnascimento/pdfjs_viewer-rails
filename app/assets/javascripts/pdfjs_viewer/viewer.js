...
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
  ...
  function webViewerSwitchScrollMode(evt) {
    ...
    // sharewis
    if (Swipe.isMobile()) {
      if (evt.mode === 3 && !Swipe.pageEnable) {
        _ui_utils.toggleCheckedBtn(document.getElementById("scrollPage"), true);
        _ui_utils.toggleCheckedBtn(document.getElementById("scrollHorizontal"), false);
        Swipe.pageEnable = true;
        PDFViewerApplication.pdfViewer.scrollMode = 1;
      } else {
        PDFViewerApplication.pdfViewer.scrollMode = evt.mode;
        if (evt.mode === 1) {
          Swipe.pageEnable = false;
          _ui_utils.toggleCheckedBtn(document.getElementById("scrollPage"), false);
          _ui_utils.toggleCheckedBtn(document.getElementById("scrollHorizontal"), true);
        }
      }
    } else {
      PDFViewerApplication.pdfViewer.scrollMode = evt.mode;
  ...
  class Toolbar {
    ...
    constructor(options, eventBus, l10n) {
      ...
      this.buttons.push({
        element: options.presentationMode,
        eventName: "presentationmode"
      })
      this.items = {
  ...
  function getViewerConfiguration() {
    return {
      ...
      toolbar: {
        ...
        presentationMode: document.getElementById("fullscreenMode")
      },
      secondaryToolbar: {
